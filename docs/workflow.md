...
> **范围**:P4 **只动 AGENTS.md**。其他文档不在 P4 范围,各有自己的演化通道:
>
> | 文档 | 是否在 P4 | 演化通道 |
> |---|---|---|
> | **AGENTS.md**(A 类规则) | ✅ 是 | 本节 —— 跨 feature 持续累积、定期主动 refresh |
...
>
> **底层逻辑**:[§0.1 命题 3 Drift](#01-这本手册解决什么) 的三个维度(时间 / 空间 / 演进)全是**规则**演化,规则只住在 AGENTS.md 里 —— 所以 P4 自然只针对它。
